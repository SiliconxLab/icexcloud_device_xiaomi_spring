...
$(foreach sku, o19cn o19cn_ss o19jp o19gl o19gl_ss o19glp o19glp_ss o19eea o19eea_ss, \
...
$(foreach sku, o19cn o19cn_ss o19jp, \
    $(eval PRODUCT_COPY_FILES += \
        $(LOCAL_PATH)/configs/permissions/com.android.se.xml:$(TARGET_COPY_OUT_ODM)/etc/permissions/sku_$(sku)/com.android.se.xml \
...
PRODUCT_COPY_FILES += \
    frameworks/native/data/etc/com.android.nfc_extras.xml:$(TARGET_COPY_OUT_ODM)/etc/permissions/sku_o19jp/com.android.nfc_extras.xml
